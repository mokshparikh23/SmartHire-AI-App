 ...
 * 127.0.0.1:3002 is the site's dev port — see apps/site/package.json for why it
 * is 3002.
 */
const WWW_ORIGIN = (process.env.NEXT_PUBLIC_WWW_URL || 'http://127.0.0.1:3002').replace(/\/$/, '')
