...
const nextConfig = {
  /* Same reason as apps/dashboard: the dev-tools indicator renders bottom-left and
     sits on top of page content. Compile and runtime errors still surface. */
  devIndicators: false,

  /* SPLIT 2026-09-01: the same backstop apps/dashboard carries, for the same reason.
  ...
  /* SPLIT 2026-09-01 ─ app paths that land here go to the app.
     ...
     This is the mirror of the two redirects in apps/dashboard/next.config.mjs, and it
     ...
     forever — the same one-way door that had to be undone in apps/dashboard on the
  ...
  async redirects() {
    ...
    return [
      ...
      /*
        ...
        apps/admin/app/robots.js to say Disallow instead of copying apps/dashboard.
      */
    ]
  },
}
