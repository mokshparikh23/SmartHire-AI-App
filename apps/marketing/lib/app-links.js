 ...
 * differ on purpose — see the port note in apps/marketing/package.json.
 */
/**
 ...
 * cannot work across the origin boundary: apps/dashboard sends
 ...
 * apps/dashboard/lib/releases.js recognises. It 302s to the current GitHub release
