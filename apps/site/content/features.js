...
export const FEATURES = [
  ...
  { id: 'cv',      icon: 'file',   title: 'Drawn from your own CV',  body: 'Paste your résumé and the job description once. Anything taken from them is tagged inline, [resume] or [JD], so you can see which part of an answer is a fact about you.' },
