/*
  ADMIN SPLIT 2026-09-01 ─ DISALLOW HERE, ALLOW IN apps/dashboard. THE DIFFERENCE IS
  DELIBERATE. Do not "harmonise" these two files.

  apps/dashboard/app/robots.js opens with "THIS FILE ALLOWS CRAWLING ON PURPOSE. DO NOT
  ...
  1. "Disallow prevents crawling, not indexing" — a URL linked from elsewhere
     ...
     apps/dashboard because the marketing site links to it from its header, its footer
     and every CTA. NOTHING LINKS HERE. apps/marketing's /admin redirect is removed
     with the split rather than repointed, apps/dashboard's dashboard sidebar has no
  ...
  2. "It would strand the redirects" — apps/dashboard 308s / and /compare to the
